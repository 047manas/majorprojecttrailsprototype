...
with app.app_context():
    def get_identity_expr():
        return case(
            (StudentActivity.start_date.isnot(None),
             func.concat(StudentActivity.activity_type_id, '-', StudentActivity.start_date)),
            else_=func.concat(StudentActivity.activity_type_id, '-', func.lower(func.trim(StudentActivity.title)))
        )
    ...
    with open('identities.log', 'w') as f:
